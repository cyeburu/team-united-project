...
var LoadingIndicator = function (props) {
    ...
    return loading ? (React.createElement(CircularProgress_1.default, __assign({ className: classnames_1.default('app-loader', classes.loader, className), color: "inherit", size: 18, thickness: 5 }, rest))) : (React.createElement(RefreshIconButton_1.default, null));
};
