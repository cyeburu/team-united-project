...
var Datagrid = function (props) {
    ...
    var _e = ra_core_1.useListContext(props), basePath = _e.basePath, currentSort = _e.currentSort, data = _e.data, ids = _e.ids, loaded = _e.loaded, onSelect = _e.onSelect, onToggleItem = _e.onToggleItem, resource = _e.resource, selectedIds = _e.selectedIds, setSort = _e.setSort, total = _e.total;
     ...
     */
    return (React.createElement(core_1.Table, __assign({ className: classnames_1.default(classes.table, className), size: size }, ra_core_1.sanitizeListRestProps(rest)),
