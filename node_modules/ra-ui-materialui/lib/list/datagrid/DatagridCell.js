...
var DatagridCell = function (_a) {
    ...
    return (React.createElement(TableCell_1.default, __assign({ className: classnames_1.default(className, field.props.cellClassName), align: field.props.textAlign }, rest), React.cloneElement(field, {
        record: record,
