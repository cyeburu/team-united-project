...
var EditActions = function (_a) {
    ...
    return (React.createElement(TopToolbar_1.default, __assign({ className: className }, sanitizeRestProps(rest)), hasShow && React.createElement(button_1.ShowButton, { basePath: basePath, record: data })));
};
