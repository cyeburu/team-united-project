...
var Tab = function (_a) {
    ...
    var renderHeader = function () { return (React.createElement(Tab_1.default, __assign({ key: label, label: translate(label, { _: label }), value: value, icon: icon, className: classnames_1.default('show-tab', className), component: react_router_dom_1.Link, to: value }, sanitizeRestProps(rest)))); };
