...
var NullableBooleanInput = function (props) {
    ...
    return (React.createElement(TextField_1.default, __assign({ id: id }, input, { select: true, margin: margin, label: React.createElement(ra_core_1.FieldTitle, { label: label, source: source, resource: resource, isRequired: isRequired }), error: !!(touched && error), helperText: React.createElement(InputHelperText_1.default, { touched: touched, error: error, helperText: helperText }), className: classnames_1.default(classes.input, className), variant: variant }, enhancedOptions, sanitizeRestProps_1.default(rest)),
        React.createElement(MenuItem_1.default, { value: "" }, translate('ra.boolean.null')),
        React.createElement(MenuItem_1.default, { value: "false" }, translate('ra.boolean.false')),
        React.createElement(MenuItem_1.default, { value: "true" }, translate('ra.boolean.true'))));
};
