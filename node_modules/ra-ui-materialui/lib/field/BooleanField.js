...
exports.BooleanField = react_1.memo(function (props) {
    ...
    if (value === false || value === true) {
        return (React.createElement(core_1.Typography, __assign({ component: "span", variant: "body2", className: classnames_1.default(classes.root, className) }, sanitizeRestProps_1.default(rest)),
            React.createElement(core_1.Tooltip, { title: translate(ariaLabel, { _: ariaLabel }) }, value === true ? (React.createElement(Done_1.default, { "data-testid": "true", fontSize: "small" })) : (React.createElement(Clear_1.default, { "data-testid": "false", fontSize: "small" })))));
    }
...
exports.BooleanField.propTypes = __assign(__assign(__assign({}, core_1.Typography.propTypes), types_1.fieldPropTypes), { valueLabelFalse: prop_types_1.default.string, valueLabelTrue: prop_types_1.default.string });
