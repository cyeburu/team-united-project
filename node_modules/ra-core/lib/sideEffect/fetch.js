...
function handleFetch(dataProvider, action) {
    ...
    return __generator(this, function (_b) {
        switch (_b.label) {
            ...
            case 3:
                _b.sent();
                return [4 /*yield*/, effects_1.call(dataProvider[core_1.sanitizeFetchType(restType)], meta.resource, payload)];
            case 4:
                response = _b.sent();
                ...
                return [4 /*yield*/, effects_1.put({
                        ...
                        meta: __assign(__assign(__assign({}, meta), successSideEffects), { fetchResponse: restType, fetchStatus: actions_1.FETCH_END }),
                    })];
            case 5:
                _b.sent();
                return [4 /*yield*/, effects_1.put({ type: actions_1.FETCH_END })];
            case 6:
                _b.sent();
                return [3 /*break*/, 14];
            case 7:
                ...
                return [4 /*yield*/, effects_1.put({
                        ...
                        requestPayload: payload,
                        meta: __assign(__assign(__assign({}, meta), failureSideEffects), { fetchResponse: restType, fetchStatus: actions_1.FETCH_ERROR }),
                    })];
            case 8:
                _b.sent();
                return [4 /*yield*/, effects_1.put({ type: actions_1.FETCH_ERROR, error: error_1 })];
            case 9:
                _b.sent();
                return [3 /*break*/, 14];
            ...
            case 11:
                ...
                return [4 /*yield*/, effects_1.put({ type: actions_1.FETCH_CANCEL })];
            case 12:
                _b.sent();
                return [2 /*return*/];
