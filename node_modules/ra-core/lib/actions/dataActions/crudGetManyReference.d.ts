...
export declare const crudGetManyReference: (reference: string, target: string, id: Identifier, relatedTo: string, pagination: Pagination, sort: Sort, filter: object, source: string) => CrudGetManyReferenceAction;
