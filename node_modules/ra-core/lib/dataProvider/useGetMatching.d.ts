import { Identifier, Pagination, Sort, Record } from '../types';
/**
 ...
 * };
 */
declare const useGetMatching: (resource: string, pagination: Pagination, sort: Sort, filter: object, source: string, referencingResource: string, options?: any) => UseGetMatchingResult;
