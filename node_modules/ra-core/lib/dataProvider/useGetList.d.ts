import { Pagination, Sort, Identifier, Record, RecordMap } from '../types';
/**
 ...
 * };
 */
declare const useGetList: <RecordType = Record>(resource: string, pagination: Pagination, sort: Sort, filter: object, options?: any) => {
