 ...
 * };
 */
declare const useGetManyReference: (resource: string, target: string, id: Identifier, pagination: Pagination, sort: Sort, filter: object, referencingResource: string, options?: any) => {
    data: {};
    ids: any;
    total: number;
    error: any;
