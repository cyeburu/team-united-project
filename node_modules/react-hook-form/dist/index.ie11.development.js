...
var filterOutFalsy = function (value) {
...
var get = function (obj, path, defaultValue) {
  ...
  var result = _reduceInstanceProperty(_context2 = filterOutFalsy(path.split(/[,[\].]+?/))).call(_context2, function (result, key) {
...
function findRemovedFieldAndRemoveListener(fieldsRef, handleChange, field, unmountFieldsStateRef, shouldUnregister, forceDelete) {
  ...
  if ((isRadioInput(ref) || isCheckBoxInput(ref)) && fieldRef) {
    ...
    if (isArray(options_1) && options_1.length) {
      ...
      _forEachInstanceProperty(_context6 = filterOutFalsy(options_1)).call(_context6, function (option, index) {
        var ref = option.ref;
...
function onDomRemove(fieldsRef, removeFieldEventListenerAndRef) {
  var observer = new MutationObserver(function () {
    ...
    try {
      for (var _c = __values(_Object$values(fieldsRef.current)), _d = _c.next(); !_d.done; _d = _c.next()) {
        var field = _d.value;

        if (field && field.options) {
          try {
            for (var _e = (e_2 = void 0, __values(field.options)), _f = _e.next(); !_f.done; _f = _e.next()) {
              var ref = _f.value.ref;
...
function useForm(_a) {
  ...
  var _h = modeRef.current,
      isOnSubmit = _h.isOnSubmit,
      isOnTouch = _h.isOnTouch;
  ...
  var updateFormState = React.useCallback(function (state) {
    ...
    return !isUnMount.current && setFormState(__assign(__assign({}, formStateRef.current), state));
  }, []);
  var shouldRenderBaseOnError = React.useCallback(function (name, error, shouldRender, state, isValid) {
    ...
    if (shouldReRender || !isEmptyObject(state)) {
      updateFormState(__assign(__assign(__assign({}, state), {
        errors: formStateRef.current.errors
      }), resolverRef.current ? {
        isValid: !!isValid
      } : {}));
          ...
          case 1:
            ...
            if (isArray(payload)) {
              ...
              isInputsValid = _everyInstanceProperty(_context14 = _mapInstanceProperty(payload).call(payload, function (name) {
                ...
                error ? set(formState.errors, name, error) : unset(formState.errors, name);
                return !error;
              ...
              shouldRenderBaseOnError(payload, error ? (_a = {}, _a[payload] = error, _a) : {}, previousFormIsValid !== isEmptyObject(errors));
              return [2
              /*return*/
              , !error];
            }
        ...
        switch (_c.label) {
          case 0:
            ...
            if (shouldSkipValidation) {
              ...
              return [2
              /*return*/
              , (!isEmptyObject(state) || shouldRender && isEmptyObject(state)) && updateFormState(state)];
            }
  ...
  function clearErrors(name) {
    ...
    name && _forEachInstanceProperty(_context16 = isArray(name) ? name : [name]).call(_context16, function (inputName) {
  ...
  function setError(name, error) {
    set(formState.errors, name, __assign(__assign({}, error), {
  ...
  function unregister(name) {
    ...
    _forEachInstanceProperty(_context17 = isArray(name) ? name : [name]).call(_context17, function (fieldName) {
  ...
  function registerFieldRef(ref, validateOptions) {
    ...
    if (field && (isRadioOrCheckbox ? isArray(field.options) && _findInstanceProperty(_context18 = filterOutFalsy(field.options)).call(_context18, function (option) {
    ...
    if (type) {
      field = isRadioOrCheckbox ? __assign({
        options: __spread(filterOutFalsy(field && field.options || []), [{
          ref: ref
        }]),
        ref: {
          type: type,
      ...
      }, validateOptions) : __assign({}, fieldRefAndValidationOptions);
    } else {
      ...
      return __awaiter(_this, void 0, void 0, function () {
        ...
        return __generator(this, function (_e) {
          ...
          switch (_e.label) {
            ...
            case 10:
              if (!(isEmptyObject(fieldErrors) && _everyInstanceProperty(_context19 = _Object$keys(formState.errors)).call(_context19, function (name) {
                var _context20;

                return _includesInstanceProperty(_context20 = _Object$keys(fieldsRef.current)).call(_context20, name);
              }))) return [3
              /*break*/
              , 12];
              updateFormState({
  ...
  var reset = function (values, omitResetState) {
    ...
    _forEachInstanceProperty(_context21 = _Object$values(resetFieldArrayFunctionRef.current)).call(_context21, function (resetFieldArray) {
  ...
  if (!resolver && readFormStateRef.current.isValid) {
    formState.isValid = deepEqual(validFieldsRef.current, fieldsWithValidationRef.current) && isEmptyObject(formState.errors);
  }
...
var fillEmptyArray = function (value) {
  ...
  return isArray(value) ? _fillInstanceProperty(_context22 = Array(value.length)).call(_context22, undefined) : undefined;
};
...
var filterBooleanArray = function (value) {
  ...
  return isArray(value) ? _flatInstanceProperty(_context23 = _mapInstanceProperty(value).call(value, mapValueToBoolean)).call(_context23) : mapValueToBoolean(value);
};
...
var mapIds = function (data, keyName) {
  ...
  return _mapInstanceProperty(_context24 = isArray(data) ? data : []).call(_context24, function (value) {
...
var useFieldArray = function (_a) {
  ...
  var _c = control || methods.control,
      ...
      _d = _c.formStateRef.current,
      dirtyFields = _d.dirtyFields,
      touched = _d.touched,
      errors = _d.errors,
      updateFormState = _c.updateFormState,
  ...
  var _e = __read(React.useState(mapIds(memoizedDefaultValues.current, keyName)), 2),
      fields = _e[0],
      setFields = _e[1];
  ...
  var getCurrentFieldsValues = function () {
    ...
    return _mapInstanceProperty(_context25 = get(getValues() || {}, name, allFields.current)).call(_context25, function (item, index) {
  ...
  var getIsDirtyState = function (flagOrFields) {
    return (readFormStateRef.current.isDirty || readFormStateRef.current.dirtyFields) && (isUndefined(flagOrFields) || !deepEqual(_mapInstanceProperty(flagOrFields).call(flagOrFields, function (_a) {
      if (_a === void 0) {
        _a = {};
      }
  ...
  var append = function (value, shouldFocus) {
    ...
    if (readFormStateRef.current.dirtyFields || readFormStateRef.current.isDirty) {
      set(dirtyFields, name, __spread(get(dirtyFields, name) || fillEmptyArray(_sliceInstanceProperty(fields).call(fields, 0, 1)), filterBooleanArray(value)));
      updateFormState({
        isDirty: true,
  ...
  var remove = function (index) {
    ...
    if ((readFormStateRef.current.dirtyFields || readFormStateRef.current.isDirty) && get(dirtyFields, name)) {
  ...
  }, [fields, name, fieldArrayDefaultValues, fieldsRef, watchFieldsRef, isWatchAllRef]);
  React.useEffect(function () {
...
var Controller = function (_a) {
  ...
  var _b = control || methods.control,
      ...
      _d = _b.formStateRef.current,
      isSubmitted = _d.isSubmitted,
      touched = _d.touched,
      updateFormState = _b.updateFormState,
  ...
  var _e = __read(React.useState(getInitialValue()), 2),
      value = _e[0],
      setInputStateValue = _e[1];
